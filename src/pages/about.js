...
export default function About() {
  return (
    <>
        ...
        <section className='relative flex flex-col justify-between px-5 w-screen h-screen text-black py-3'>
        
            <div className='z-30'>
                <div className='z-50 text-5xl text-slate-600 font-bold pt-24 leading-[60px]'>
                    <pre>
                        Hi! <br />
                        I'm Kolawole <br />
                        A Frontend <br /> 
                ...
                <div className='text-lg text-slate-600'>
                    <p>I build Fast, Generic, and Responsive Websites or Web Applications.</p>
                    <p>Do not hesitate to hire me.</p>
                </div>
            </div>
