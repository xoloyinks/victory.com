  ...
  return (
    <>
        ...
        <section className='relative flex flex-col justify-between px-5 w-screen h-screen text-black py-5'>
            ...
            <div className='z-30'>
                <div className='z-50 text-5xl font-bold pt-28 leading-[60px]'>
                    <pre>
                        Hi! <br />
                        I'm Kolawole
                    </pre>
            ...
            <div className='flex justify-evenly text-2xl text-white'>
                <a href="/twitter.com" className='border-2 border-black rounded-full p-4 bg-slate-600'><FaTwitter /></a> 
                <a href="/twitter.com" className='border-2 border-black rounded-full p-4 bg-slate-600'><FaEnvelope /></a> 
                <a href="/twitter.com" className='border-2 border-black rounded-full p-4 bg-slate-600'><FaLinkedin /></a> 
                <a href="/twitter.com" className='border-2 border-black rounded-full p-4 bg-slate-600'><FaWhatsapp /></a> 
            </div>

            <div className='me w-full h-[280px] rounded-full self-center border-2 border-slate-400 shadow-lg'>
            </div>
        </section>
    </>
  )
